...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Fine-tune an SQA (no CoT) model.")
    ...
    parser.add_argument(
        "--peft_save_dir",
        type=str,
        default="SQALlama-3.1-8B-no-CoT",
    ...
    parser.add_argument(
        "--hub_save_id",
        type=str,
        default="rad1an/SQALlama-3.1-8B-no-CoT",
    ...
    # print(dataset[0])
    # print(dataset)
    dataset.save_to_disk("sqa_no_cot_chat_dataset")
