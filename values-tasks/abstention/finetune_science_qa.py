...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval_steps', type=int, default=40, help='The number of steps between evaluations.')
    ...
    parser.add_argument('--save_steps', type=int, default=40, help='The number of steps between saving the model to the hub.')
    ...
    base_url = "/home/bingbw/lab-scale-ai/tasks/"
    data = load_dataset('json', data_files={'train': base_url + 'qasper_train.json', 'validation': base_url + 'qasper_dev.json'})
    ...
    print("valid data length",len(validation_data))
