...
def format_data_as_instructions(data: Mapping,
    ...
    print("data length in mapping", len(data))
    for i in tqdm(range(len(data['answer'])), desc='Formatting data'):
        # test_question = f"""\n\n## Context:\n{data['context'][i]}\n\n## Question:\n{data['question'][i]}\n\n## Answer:"""
...
def get_dataset_slices(dataset: str,
                       ...
                       validation_slice: str = 'validation',
                       test_slice: str = 'test') -> dict:
    """
